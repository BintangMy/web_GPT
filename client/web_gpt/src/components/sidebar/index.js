...
const Menus = [
  ...
  { title: "Chat Bot", src: "User", color: "#00A67E", icon: <BsRobot /> },
  {
    ...
    <div className="fixed z-[1000] h-screen flex items-end justify-end">
      ...
      >
        <div className="mt-3 ml-3 flex relative">
          ...
          <button
            className={`lg:hidden z-90 absolute ${!open ? "-right-10" : "-right-14"}  bg-black w-10 h-10 rounded-lg flex justify-center items-center text-white text-4xl hover:bg-slate-700`}
        ...
        <ul className="pt-6">
          {Menus.map((Menu, index) => (
            <li
              ...
              ${Menu.gap ? "mt-9" : "mt-2"} ${!open && "invisible"}  
